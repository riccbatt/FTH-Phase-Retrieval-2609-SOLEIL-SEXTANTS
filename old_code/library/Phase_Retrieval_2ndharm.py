...
def PhaseRtrv_init(diffract,mask, mask2,smth_func=1,Nit=500,beta_zero=0.5, beta_mode='const',gamma=None, Phase=0, seed=False, bsmask=0,SW_sigma_list=0, SW_thr_list=0, roi_oh=np.s_[:,:], Nmodes=1):
    '''
    ...
    return Error_diffr_list,Error_supp_list, Beta, gamma_cp, guess, BSmask_cp, guess_cp, mask_cp, mask_cp_oh,diffract_cp, smth_func_cp, convolved, prev,SW_sigma_list, SW_thr_list


#################
def PhaseRtrv_GPU2(diffract,mask,mask2=None,mode='ER',Nit=500,beta_zero=0.5, beta_mode='const',gamma=None, RL_freq=1e9, RL_it=1, Phase=0,seed=False,
       plot_every=2000, bsmask=0, real_object=False, average_img=10, Fourier_last=True, smth_func=1, SW_freq=200000,SW_sigma_list=0, SW_thr_list=0, alpha=0.03, roi_oh=np.s_[:,:], Nmodes=1):
    ...
    Error_diffr_list,Error_supp_list, Beta, gamma_cp2, guess, BSmask_cp, guess_cp2, mask_cp,mask_cp_oh, diffract_cp, smth_func_cp, convolved2, prev2,SW_sigma_list, SW_thr_list = PhaseRtrv_init(diffract,mask,mask2, smth_func=1,Nit=Nit,beta_zero=beta_zero, beta_mode=beta_mode,gamma=gamma, Phase=Phase, seed=False, bsmask=bsmask,SW_sigma_list=SW_sigma_list, SW_thr_list=SW_thr_list, roi_oh=roi_oh, Nmodes=Nmodes)
